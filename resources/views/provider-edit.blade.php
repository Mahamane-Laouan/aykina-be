...
@section('body')
    ...
    @endsection
    @section('content')
        {{-- Edit Provider Headline --}}
        <div class="row align-items-center">
            <div class="col-9" style="padding-top: 18px;">
                <div class="mb-3">
                    <h5 class="card-title">Edit Provider <span class="text-muted fw-normal ms-2"></span>
                    </h5>
                    <p class="text-muted">Provider List / Edit Provider</p>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('provider-update', ['id' => $user->id]) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                @else
                                    <div class="existing-images-preview"
                                        style="max-width: 150px; max-height: 140px; overflow: hidden;">
                                        <img id="existingImage" src="{{ asset('images/user/default_provider.jpg') }}"
                                            alt="Default Image"
                                            style="width: 100%; height: 100px; object-fit: contain; margin-block: 1rem"
                                            class="existing-image">
                                    </div>
