...
@section('body')
    ...
    @endsection
    @section('content')
        {{-- Cancellation Policy Headline --}}
        <div class="row align-items-center">
            <div class="col-md-3" style="padding-top: 18px;">
                <div class="mb-3">
                    <h5 class="card-title">Cancellation Policy <span class="text-muted fw-normal ms-2"></span>
                    </h5>
                    <p class="text-muted">Pages / Cancellation Policy</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12" style="padding-top: 25px;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('cancel-policysave') }}" method="POST" id="cancelPolicyForm">
                            @csrf
    ...
    @section('scripts')
        ...
        <script>
            ...
            document.getElementById('cancelPolicyForm').onsubmit = function() {
