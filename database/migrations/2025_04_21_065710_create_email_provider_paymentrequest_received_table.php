...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_paymentrequest_received', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_paymentrequest_received')->insert([
      'id' => 1,
      'logo' => '1739968886.jpg',
      'title' => 'Payment Request Received',
      'body' => 'You have received a payment request from the [[handyman_name]] for the [[service_name]] of booking [[booking_id]]. Please review the details and process the payment at your earliest convenience.',
  ...
  {
    Schema::dropIfExists('email_provider_paymentrequest_received');
  }
};
