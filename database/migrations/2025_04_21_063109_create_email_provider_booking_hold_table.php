...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_booking_hold', function (Blueprint $table) {
      ...
      $table->integer('get_email')->default(1); // Not nullable
      $table->timestamps(); // created_at & updated_at
    });


    // Insert default about content
    DB::table('email_provider_booking_hold')->insert([
      'id' => 1,
      'logo' => '1739968594.jpg',
      'title' => 'Booking Hold',
      'body' => 'Booking has been on hold by [[handyman_name]] of booking [[booking_id]]. Thank you for choosing our service.',
  ...
  {
    Schema::dropIfExists('email_provider_booking_hold');
  }
};
