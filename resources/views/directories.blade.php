                ...
                <div class="relative z-20 p-6 text-gray-900 rounded-lg shadow-md w-[100%] bg-white py-10">
                    ...
                    <div id="stepContent1" class="step-content">
                        <div class="grid items-center justify-between md:flex">
                            <div class="mt-[-1rem]">
                                <h2
                                    ...
                                    <b> Step 2 </b> : Directories Permissions
                                </h2>
                        ...
                        <div class="container">
                            ...
                            <h2 class="text-lg font-semibold text-center mb-4">Directories Permissions Check</h2>

                            <table class="w-full border-collapse border border-gray-300 text-center">
                                <tr class="bg-gray-100">
                                    <th class="border border-gray-300 px-4 py-2">Directory</th>
                                    <th class="border border-gray-300 px-4 py-2">Status</th>
                                </tr>
                                @foreach ($permissionsStatus as $dir => $status)
                                    <tr>
                                        <td class="border border-gray-300 px-4 py-2">{{ $dir }}</td>
                                        <td
                                            class="border border-gray-300 px-4 py-2 {{ $status ? 'text-green-600' : 'text-red-600' }}">
                                            {{ $status ? '✔' : '❌' }}
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <!-- Buttons -->
                            {{-- <div class="flex justify-center items-center w-full h-full mt-6">
                                <a href="{{ url('/validate') }}" class="next-btn">
                                    Next →
                                </a>
                            </div> --}}
                            ...
                            <div class="next-btn-container">
                                <a href="{{ url('validate') }}" class="next-btn"
                                    @if (in_array(false, $permissionsStatus))
                                        onclick="showPermissionError(event)"
                                    @endif>
                                    Next ➡
                                </a>
                            </div>
...
<script>
    function showPermissionError(event) {
        event.preventDefault(); // Page redirect hone se roke
        alert("Some required directories are not writable. Please fix permissions before proceeding.");
    }
</script>
