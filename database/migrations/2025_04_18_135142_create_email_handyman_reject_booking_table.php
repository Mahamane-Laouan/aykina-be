...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_handyman_reject_booking', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_handyman_reject_booking')->insert([
      'id' => 1,
      'logo' => '1736240989.png',
  ...
  {
    Schema::dropIfExists('email_handyman_reject_booking');
  }
};
