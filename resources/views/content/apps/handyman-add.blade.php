...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Handyman /</span><span> Add Handyman</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Add Handyman</h4>
        ...
        <form class="add-vendor pt-0" id="addVendorForm" method="post" action="{{ route('handyman-save') }}"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        backButton.addEventListener("click", function() {
            window.location.href = "{{ route('handyman-list') }}";
        });
    });
</script>
