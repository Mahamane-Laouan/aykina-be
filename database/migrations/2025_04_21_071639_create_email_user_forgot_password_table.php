...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_forgot_password', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_forgot_password')->insert([
      'id' => 1,
      'logo' => '1740060491.jpg',
    ...
    {
        Schema::dropIfExists('email_user_forgot_password');
    }
};
