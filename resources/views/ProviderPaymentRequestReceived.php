...
$email = ProviderEmailPaymentRequestReceived::first();
            ...
            ">
                    ...
                    <h4 style="color: #333333; font-weight: 500">
                        <?= htmlspecialchars(str_replace(
                            ['[[booking_id]]', '[[handyman_name]]', '[[service_name]]'],
                            ['#' . $booking_id, $handyman_name, $service_name],
                            $email->body
                        )) ?>
                    </h4>
                    ...
                    <ul style="list-style-type: none; padding: 0">
                        <li style="margin-bottom: 0.5rem">
                            <span style="font-weight: 600; color: #555555">Amount:</span>
                            <span style="color: #555555">#<?= htmlspecialchars($amount) ?></span>
                        </li>
