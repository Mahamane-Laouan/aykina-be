                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="v_id" class="form-label">Provider <span
                                                        style="color: red;">*</span></label>
                                                <select class="form-control" data-trigger id="v_id" name="v_id">
                                                    <option value="">Select Provider</option>
                                                    @foreach ($vendors as $value)
                                                        <option value="{{ $value->id }}"
                                                            {{ $value->id == $data->v_id ? 'selected style=color:green;' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" data-trigger id="product_id"
                                                    name="product_id">
    ...
    alert('Failed to delete image.');
        ...
        <script>
            function deleteImage(id, element) {
                fetch(`{{ url('service-imagedelete') }}/${id}`, {
                        method: 'POST',
                        headers: {
