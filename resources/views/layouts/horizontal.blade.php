        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <!-- <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/logo/nlytical.png') }}" alt="" height="26">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('assets/images/logo/nlytical.png') }}" alt="" height="28">
                    </span>
                </a>
                ...
                <a href="index" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('assets/images/logo/nlytical.png') }}" alt="" height="30">
                    </span>
                </a> -->
                <a id="logo" href="index">
                    <span>
                        <img src="{{ URL::asset('assets/images/logo/nlytical.png') }}" alt="" height="28" style="margin-top: 26px;">
                    </span>
                </a>
            </div>
