...
@section('content')
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Handyman Request List<span
                        class="text-muted fw-normal ms-2">({{ $users->total() }})</span>
                </h5>
                <p class="text-muted">Handyman / Handyman Request List</p>
            </div>
        </div>
                                        ...
                                        <tr>
                                                    ...
                                                    <div>
                                                        ...
                                                        @else
                                                            ...
                                                            <span class="avatar rounded-circle img-thumbnail me-2"
                                                                ...
                                                                {{ strtoupper(substr($user->firstname . ' ' . $user->lastname, 0, 1)) }}
                                                            </span>
                                                        @endif
                                                    </div>
                                            ...
                                            <td>
                                                <button type="button"
                                                    ...
                                                    onclick="ProviderhandymanRequestApproval({{ $user->id }})">
                                                ...
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            ...
                                                            onclick="ignoreProviderHandyman({{ $user->id }})"><i
...
<script>
    ...
    function ignoreProviderHandyman(id) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.value) {
                $.ajax({
                    url: baseUrl + 'providerhandyman-ignore/' + id,
                    type: 'POST',
                    headers: {
    ...
    function ProviderhandymanRequestApproval(id) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: baseUrl + 'providerhandyman-requestapproval/' + id,
                    ...
                    success: function(data) {
                        ...
                        if (data.message === 'Request accepted successfully') {
                            Swal.fire({
                                ...
                                window.location.href = baseUrl + 'providerhandyman-list';
                            });
                        } else {
                            Swal.fire({
                                icon: 'error',
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('providerhandyman-requestlist') }}?search=${query}`, {
                        headers: {
                    ...
                    .then(data => {
                        ...
                        if (data.records.length > 0) {
                            ...
                            <tr>
                                    ...
                                    <div style="display: flex; align-items: center;">
                                        <div>
                                            ${record.profile_pic
                                                ...
                                                : `<span class="avatar rounded-circle img-thumbnail me-2" style="background-color: #ddd; color: #fff; display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px;">
                                ...
                                <td>
                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" onclick="ProviderhandymanRequestApproval(${record.id})">
                                            <i class="fas fa-check"></i> Approve
                                        </button>
                                    </td>
                                    <td>
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item">
                                                <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="top" title="Ignore" class="px-2 text-danger" onclick="ignoreProviderHandyman(${record.id})">
