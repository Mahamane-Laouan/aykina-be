...
$email = UserEmailProductInProgress::first();
            ...
            ">
                    ...
                    <ul style="list-style-type: none; padding: 0">
                        <li style="margin-bottom: 0.5rem">
                            <span style="font-weight: 600; color: #555555">Booking:</span>
                            <span style="color: #555555">#<?= htmlspecialchars($booking_id) ?></span>
                        </li>

                        <li style="margin-bottom: 0.5rem">
                            <span style="font-weight: 600; color: #555555">Product Name: </span>
                            <span style="color: #555555"><?= htmlspecialchars($product_name) ?></span>
                        </li>
                        <li style="margin-bottom: 0.5rem">
                            <span style="font-weight: 600; color: #555555">Date: </span>
                            <span style="color: #555555"><?= htmlspecialchars($date) ?></span>
                        </li>
                    </ul>
                </div>
