...
@section('body')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="addproduct-accordion" class="custom-accordion">
                    <form action="{{ route('providerproduct-update', ['id' => $data->product_id]) }}" method="POST"
                                                ...
                                                @foreach ($data->productImages as $value)
                                                    <div class="image-container position-relative me-4 mb-3 border rounded"
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            onclick="imageDeleteProviderProduct({{ $value->id }}, this)">
                                                            &times;
                                                        </button>
                                                    </div>
                                                @endforeach
    ...
    @section('scripts')
        ...
        <script>
            function imageDeleteProviderProduct(id, element) {
                fetch(`{{ url('providerproduct-imagedelete') }}/${id}`, {
                        method: 'POST',
                        headers: {
