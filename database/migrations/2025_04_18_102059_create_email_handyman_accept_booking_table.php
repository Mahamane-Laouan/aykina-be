...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_handyman_accept_booking', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_handyman_accept_booking')->insert([
      'id' => 1,
      'logo' => '1739969662.jpg',
      'title' => 'Payment Request Accepted',
      'body' => '[[service_name]] of Booking ID [[booking_id]] Payment Request has been cancelled [[currency]][[amount]]',
  ...
  {
    Schema::dropIfExists('email_handyman_accept_booking');
  }
};
