...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Category /</span><span> Edit Category</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <p class="text-muted">Explore and edit category</p>
            </div>
        ...
        <form class="edit-category pt-0" id="editCategoryForm" method="post"
            action="{{ route('categories-update', ['id' => $category->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group" style="padding-bottom: 20px;">
                                    <label class="form-label" for="img">Category Image<span
                                            style="color: red;">*</span></label>
