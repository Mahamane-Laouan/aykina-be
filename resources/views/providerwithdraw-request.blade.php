...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Withdraw Request <span
                        class="text-muted fw-normal ms-2">({{ $records->total() }})</span>
                </h5>
                <p class="text-muted">Order Management / Withdraw Request</p>
            </div>
        </div>
    </div>
                                        ...
                                        <td colspan="3" class="text-center">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <i class="bx bx-transfer" style="font-size: 2.5rem; color: #fff;"></i>
                                                </div>
                                                <p
                                                    style="margin-top: 0.6rem; font-size: 1.1rem; font-weight: 500; color: #444;">
                                                    No Withdraw Request Found</p>
                                            </div>
                                        </td>
                                    </tr>
                                @else
                                    @foreach ($records as $record)
                                        <tr>
                                            ...
                                            <td>{{ $defaultCurrency }}{{ $record->amount ?? '' }}</td>
