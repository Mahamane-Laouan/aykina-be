...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Services /</span><span> Edit Service</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Edit Service</h4>
        ...
        <form class="edit-service pt-0" id="editServiceForm" method="post"
            action="{{ route('services-update', ['id' => $service->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- Service Information -->
                <div class="col-12 col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-label" for="service_name">Service Name<span
                                            style="color: red;">*</span></label>
                                    <input type="text" id="service_name" value="{{ $service->service_name }}"
                            ...
                            <div class="form-check mb-2">
                                ...
                                <label class="form-label" for="status">Featured Category Services</label>
                            </div>
                            ...
                            <div style="padding-bottom: 20px;">
                                ...
                                <div class="form-control p-0 pt-1">
                                    ...
                                    <div class="comment-editor border-0 pb-4" id="service_description">
                                        {!! old('service_description', $service->service_description) !!}</div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label class="form-label" for="service_phone">Phone Number<span
                                            style="color: red;">*</span></label>
                                    <input type="number" id="service_phone" value="{{ $service->service_phone }}"
                                ...
                                <div class="col">
                                    <label class="form-label" for="service_price">Price<span
                                            style="color: red;">*</span></label>
                                    <input type="text" id="service_price" value="{{ $service->service_price }}"
                                        placeholder="Enter Price" name="service_price"
                            ...
                            <div class="row mb-3">
                                <!-- Service Price Unit Dropdown -->
                                <div class="mb-3 col ecommerce-select2-dropdown" style="padding-top: 4px;">
                                    <label class="form-label mb-1 d-flex justify-content-between align-items-center"
                                        for="price_unit">
                                        <span>Service Price Unit<span style="color: red;">*</span></span>
                                    </label>
                                    <select id="price_unit" class="select2 form-select" name="price_unit"
                                        ...
                                        <option value="Fixed" {{ $service->price_unit == 'Fixed' ? 'selected' : '' }}>
                                            Fixed</option>
                                        <option value="Hourly" {{ $service->price_unit == 'Hourly' ? 'selected' : '' }}>
                                            Hourly</option>
                                        <option value="Free" {{ $service->price_unit == 'Free' ? 'selected' : '' }}>Free
                                        </option>
                                    </select>
                                </div>
                                    ...
                                    <select id="v_id" name="v_id" class="select2 form-select"
                                        ...
                                        @foreach ($vendors as $vendor)
                                            <option value="{{ $vendor->id }}"
                                                {{ $vendor->id == $service->v_id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label class="form-label" for="promo_offer">Service Promo Offer<span
                                            style="color: red;">*</span></label>
                                    <input type="text" id="promo_offer" value="{{ $service->promo_offer }}"
                                        placeholder="Enter Promo Offer" name="promo_offer"
                            ...
                            <div class="mb-3 col ecommerce-select2-dropdown">
                                ...
                                <select class="select2 form-select" data-placeholder="Select Days" name="day[]"
                                    multiple="multiple">
                                    <option value="Mon" {{ in_array('Mon', $existingDays) ? 'selected' : '' }}>Monday
                                    </option>
                                    <option value="Tue" {{ in_array('Tue', $existingDays) ? 'selected' : '' }}>Tuesday
                                    </option>
                                    <option value="Wed" {{ in_array('Wed', $existingDays) ? 'selected' : '' }}>
                                        Wednesday</option>
                                    <option value="Thu" {{ in_array('Thu', $existingDays) ? 'selected' : '' }}>Thursday
                                    </option>
                                    <option value="Fri" {{ in_array('Fri', $existingDays) ? 'selected' : '' }}>Friday
                                    </option>
                                    <option value="Sat" {{ in_array('Sat', $existingDays) ? 'selected' : '' }}>Saturday
                                    </option>
                                    <option value="Sun" {{ in_array('Sun', $existingDays) ? 'selected' : '' }}>Sunday
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="mb-3 col ecommerce-select2-dropdown">
                                    ...
                                    <select id="slot_book" name="slot_book" class="select2 form-select"
                                        ...
                                        <option value="1 Hours"
                                            {{ in_array('1 Hours', $existingHours) ? 'selected' : '' }}>
                                            1 Hours
                                        </option>
                                        <option value="2 Hours"
                                            {{ in_array('2 Hours', $existingHours) ? 'selected' : '' }}>
                                            2 Hours
                                        </option>
                                        <option value="3 Hours"
                                            {{ in_array('3 Hours', $existingHours) ? 'selected' : '' }}>
                                            3 Hours</option>
                                        <option value="4 Hours"
                                            {{ in_array('4 Hours', $existingHours) ? 'selected' : '' }}>
                                            4 Hours
                                        </option>
                                        <option value="5 Hours"
                                            {{ in_array('5 Hours', $existingHours) ? 'selected' : '' }}>
                                            5 Hours
                                        </option>
                                        <option value="6 Hours"
                                            {{ in_array('6 Hours', $existingHours) ? 'selected' : '' }}>
                                            6 Hours
                                        </option>
                                        <option value="7 Hours"
                                            {{ in_array('7 Hours', $existingHours) ? 'selected' : '' }}>
                                            7 Hours
                                        </option>
                                        <option value="8 Hours"
                                            {{ in_array('8 Hours', $existingHours) ? 'selected' : '' }}>
                                            8 Hours
                                        </option>
                                        <option value="Full Day"
                                            {{ in_array('Full Day', $existingHours) ? 'selected' : '' }}>
                                            Full Day
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="position: relative;" class="form-control" name="address" rows="2"
                                        placeholder="Enter Your Service Location" id="pac-input">{{ $service->service_address ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group creat-map-img" style="padding-bottom: 20px">
                                ...
                                <div id="map" data-lat="{{ $service->lat }}" data-lng="{{ $service->lon }}"
