...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_handyman_booking_completed', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_handyman_booking_completed')->insert([
      'id' => 1,
      'logo' => '1736242767.png',
      'title' => 'Booking Successfully Completed',
      'body' => 'We are pleased to inform you that your booking has been successfully completed! Thank you for choosing handyman. We look forward to providing you with exceptional service.',
  ...
  {
    Schema::dropIfExists('email_handyman_booking_completed');
  }
};
