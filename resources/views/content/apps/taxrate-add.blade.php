...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Tax Rate /</span><span> Add Tax</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Add Tax</h4>
                <p class="text-muted">Adding Value, One Tax at a Time</p>
            </div>
        </div>

        <form class="add-category pt-0" id="addCategoryForm" method="post" action="{{ route('taxrate-save') }}">
            @csrf
            <div class="row">
