...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_booking_inprogress', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_booking_inprogress')->insert([
      'id' => 1,
      'logo' => '1735884219.png',
      'title' => 'Booking In Progress',
      'body' => 'Your Booking ID [[booking_id]] is in progress by [[provider_name]]. Thank you for choosing our service.',
   ...
   */
    ...
    {
        Schema::dropIfExists('email_user_booking_inprogress');
    }
};
