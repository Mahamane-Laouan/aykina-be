...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Provider /</span><span> Edit Provider</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Edit Provider</h4>
        ...
        <form class="edit-category pt-0" id="editCategoryForm" method="post"
            action="{{ route('providers-update', ['id' => $user->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
