...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_handyman_otp_verify', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_handyman_otp_verify')->insert([
      'id' => 1,
      'logo' => '1739969350.jpg',
      'title' => 'Otp Verification',
      'body' => 'Your verification code of email is',
  ...
  {
    Schema::dropIfExists('email_handyman_otp_verify');
  }
};
