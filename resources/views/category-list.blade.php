...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Category List <span class="text-muted fw-normal ms-2">({{ $records->total() }})</span>
                </h5>
                <p class="text-muted">Service Management / Category List</p>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="d-flex justify-content-between align-items-center" style="padding-top: 15px;">
                    ...
                    <h2 class="card-title" style="margin-left: 25px;">Category List</h2>

                    <a href="{{ route('category-add') }}" class="btn btn-primary" style="margin-right: 25px;">Add
                        Category</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-nowrap align-middle">
                            <thead class="table-light">
                                <tr>
                                    <th scope="col" style="min-width: 16rem; color: #ffff;">Category Name</th>
                                    <th scope="col" style="color: #ffff;">Category Image</th>
                                        ...
                                        <td colspan="4" class="text-center">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <i class="bx bx-aperture" style="font-size: 2.5rem; color: #fff;"></i>
                                                </div>
                                                <p
                                ...
                                @else
                                    @foreach ($records as $user)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($user->img)
                                                    <img src="{{ asset('images/category_images/' . $user->img) }}"
                                                        alt="Category Image" style="height: 6rem; width: 6rem;"
                                            ...
                                            <td>
                                                <div class="form-check form-switch mb-3" dir="ltr"
                                                    ...
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        onchange="changeCategoryStatus ({{ $user->id }}, this.checked)"
                                                ...
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                            ...
                                                            onclick="deleteCategory({{ $user->id }})"><i
...
@section('scripts')
    ...
    <script>
        ...
        function changeCategoryStatus(id, isChecked) {
            ...
            var statusMessage = isChecked ? "\u2714 Category Activated" : "\u26A0 Category Deactivated";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('category-list') }}?search=${query}`, {
                        headers: {
    ...
    <td>
        <div class="form-check form-switch mb-3" dir="ltr" style="padding-top: 10px;">
            <input type="checkbox" class="form-check-input"
                ...
                onchange="changeCategoryStatus(${record.id}, this.checked)" style="transform: scale(1.1);">
...
`;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ${record.img
                                            ? `<img src="${record.img}" alt="Category Image" style="height: 6rem; width: 6rem;" class="avatar rounded-circle img-thumbnail me-2">`
                                            : ''}
                                    </td>
                                                                                                           ${blockedStatusTd}
                                    ...
                                    <td>
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item">
                                                <a class="px-2 text-danger" onclick="deleteCategory(${record.id})"><i class="bx bx-trash-alt font-size-18"></i></a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>`;
