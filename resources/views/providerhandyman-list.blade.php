        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center" style="padding-top: 15px;">
                    ...
                    <!-- Add Faq Button -->
                    <a href="{{ route('providerhandyman-add') }}" class="btn btn-primary" style="margin-right: 25px;">Add
                        Handyman</a>
                </div>
                <div class="card-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    ...
                                                    <div style="display: flex; flex-direction: column; width: fit-content;">
                                                        ...
                                                        <a href="{{ route('providerhandyman-view', $user->id) }}"
                                            ...
                                            <td>
                                                <div class="form-check form-switch mb-3" dir="ltr"
                                                    ...
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        onchange="ChangeProviderHandymanListBlocked({{ $user->id }}, this.checked)"
                                            ...
                                            <td>
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('providerhandyman-edit', $user->id) }}"
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                            ...
                                                            onclick="deleteProviderHandyman({{ $user->id }})"><i
...
@section('scripts')
    ...
    <script>
        ...
        function ChangeProviderHandymanListBlocked(id, isChecked) {
            ...
            $.ajax({
                url: baseUrl + 'change-providerhandymanlistblocked/' + id,
                type: 'get',
                headers: {
...
<script>
    var baseUrl = "{{ url('/') }}/";
    // Delete Provider
    function deleteProviderHandyman(userId) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.value) {
                $.ajax({
                    url: 'providerhandyman-delete/' + userId,
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('providerhandyman-list') }}?search=${query}`, {
                        headers: {
    ...
    <td>
        <div class="form-check form-switch mb-3" dir="ltr" style="padding-top: 10px;">
            <input type="checkbox" class="form-check-input"
                ...
                onchange="ChangeProviderHandymanListBlocked(${record.id}, this.checked)" style="transform: scale(1.1);">
            ...
            <small class="text-muted">${truncateText(record.email ?? '', 30)}</small>
                                ...
                                <td>
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a class="px-2 text-danger" onclick="deleteProviderHandyman(${record.id})" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
