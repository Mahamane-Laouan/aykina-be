...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_refund', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_refund')->insert([
      'id' => 1,
      'logo' => '1740563227.png',
      'title' => 'User Refund by Provider',
      'body' => 'Refund Amount [[service_name]] [[currency]][[amount]] for Booking ID [[booking_id]] has been processed.',
    ...
    {
        Schema::dropIfExists('email_user_refund');
    }
};
