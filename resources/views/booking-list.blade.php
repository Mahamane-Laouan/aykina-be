...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Booking Orders <span class="text-muted fw-normal ms-2">({{ $records->total() }})</span>
                </h5>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('booking-list') }}?search=${query}`, {
                        headers: {
                    ...
                    .then(data => {
                        ...
                        if (data.records.length > 0) {
                            data.records.forEach(record => {
                                ...
                                let handymanStatusBadge = '';
                                switch (record.handyman_status) {
                                    case 0:
                                        handymanStatusBadge =
                                            '<span class="badge bg-warning text-white font-size-14" style="height: 30px; padding-top: 8px;">Pending</span>';
                                        break;
                                    case 1:
                                        handymanStatusBadge =
                                            '<span class="badge bg-primary text-white font-size-14" style="height: 30px; padding-top: 8px;">Accepted</span>';
                                        break;
                                    case 2:
                                        handymanStatusBadge =
                                            '<span class="badge bg-primary text-white font-size-14" style="height: 30px; padding-top: 8px;">Accepted</span>';
                                    ...
                                    case 3:
                                        handymanStatusBadge =
                                            '<span class="badge bg-danger text-white font-size-14" style="height: 30px; padding-top: 8px;">Rejected</span>';
                                        break;
                                    case 4:
                                        handymanStatusBadge =
                                            '<span class="badge bg-info text-white font-size-14" style="height: 30px; padding-top: 8px;">In Progress</span>';
                                        break;
                                    case 5:
                                        handymanStatusBadge =
                                            '<span class="badge bg-danger text-white font-size-14" style="height: 30px; padding-top: 8px;">Rejected</span>';
                                    ...
                                    case 6:
                                        handymanStatusBadge =
                                            '<span class="badge bg-success text-white font-size-14" style="height: 30px; padding-top: 8px;">Completed</span>';
                                        break;
                                    case 7:
    handymanStatusBadge =
        '<span class="badge" style="background-color: #FF6F00; color: white; height: 30px; padding-top: 8px; font-size: 14px;">Hold</span>';
    break;

                                    case 8:
                                        handymanStatusBadge =
                                            '<span class="badge bg-danger text-white font-size-14" style="height: 30px; padding-top: 8px;">Cancelled</span>';
                                        break;
                                    case 9:
                                        handymanStatusBadge =
                                            '<span class="badge bg-info text-white font-size-14" style="height: 30px; padding-top: 8px;">In Progress</span>';
                                    ...
                                    case 10:
                                        handymanStatusBadge =
                                            '<span class="badge bg-success text-white font-size-14" style="height: 30px; padding-top: 8px;">Delivered</span>';
                                        break;

                                        case 12:
                                        handymanStatusBadge =
                                            '<span class="badge bg-danger text-white font-size-14" style="height: 30px; padding-top: 8px;">Cancelled By User</span>';
                                        break;
                                    default:
                                        handymanStatusBadge =
                                            '';
