...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_forgot_password', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_forgot_password')->insert([
      'id' => 1,
      'logo' => '1739965312.jpg',
      'title' => 'Change Password Request',
      'body' => 'Your verification code for change password is',
  ...
  {
    Schema::dropIfExists('email_provider_forgot_password');
  }
};
