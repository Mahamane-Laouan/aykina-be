...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Sub Category /</span><span> Add Sub Category</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Add Sub Category</h4>
                <p class="text-muted">Explore and add sub category</p>
            </div>
        ...
        <form class="add-category pt-0" id="addCategoryForm" method="post" action="{{ route('subcategories-save') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group" style="padding-bottom: 20px;">
                                    <label class="form-label" for="img">Sub Category Image<span style="color: red;">
                                            *</span></label>
