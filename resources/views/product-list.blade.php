    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center" style="padding-top: 15px;">
                ...
                <a href="{{ route('product-add') }}" class="btn btn-primary" style="margin-right: 25px;">Add
                    Product</a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-nowrap align-middle">
                        <thead class="table-light">
                            <tr>
                                <th scope="col" style="min-width: 25rem; color: #ffff;">Product</th>
                                        ...
                                        <td>
                                            <div class="form-check form-switch mb-3" dir="ltr" style="padding-top: 10px;">
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    onchange="ChangeProductStatus({{ $user->product_id }}, this.checked)"    style="transform: scale(1.1);">
                                        ...
                                        <td>
                                            <div class="form-check form-switch mb-3" dir="ltr"
                                                ...
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    onchange="changeProductListStatus ({{ $user->product_id }}, this.checked)"
                                            ...
                                            <ul class="list-inline mb-0">
                                                ...
                                                <li class="list-inline-item">
                                                    <a data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        onclick="deleteProduct({{ $user->product_id }})"><i
...
<script>
    ...
    function changeProductListStatus(product_id, isChecked) {
        ...
        $.ajax({
            url: baseUrl + 'change-productliststatus/' + product_id,
            type: 'get',
            headers: {
...
<script>
    ...
    // ChangeProductStatus;
    function ChangeProductStatus(id, type) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: baseUrl + 'change-productstatus/' + id,
                    type: 'get',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('product-list') }}?search=${encodeURIComponent(query)}`, {
                        headers: {
    ...
    <td>
        <div class="form-check form-switch mb-3" dir="ltr" style="padding-top: 10px;">
            <input type="checkbox" class="form-check-input"
                ...
                onchange="changeProductListStatus(${record.product_id}, this.checked)" style="transform: scale(1.1);">
...
`;
    ...
    <div class="form-check form-switch" style="padding-top: 2px;">
        <input type="checkbox" class="form-check-input" id="customSwitch${record.id}" ${record.is_features == 1 ? 'checked' : ''} onchange="ChangeProductStatus(${record.product_id}, this.checked)" style="transform: scale(1.1);">
        <label class="form-check-label" for="customSwitch${record.product_id}"></label>
    </div>
</td>
                                    ...
                                    <td>
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item">
                                                <a href="#" class="px-2 text-danger" onclick="deleteProduct(${record.product_id})" data-bs-toggle="tooltip" title="Delete"><i class="bx bx-trash-alt font-size-18"></i></a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>`;
