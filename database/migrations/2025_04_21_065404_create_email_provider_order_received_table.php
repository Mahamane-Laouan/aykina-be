...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_order_received', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_order_received')->insert([
      'id' => 1,
      'logo' => '1739360665.jpg',
      'title' => 'Order Received',
      'body' => 'We are pleased to inform you that you have a new order with booking {{booking_id}}, placed on {{booking_date}}.',
  ...
  {
    Schema::dropIfExists('email_provider_order_received');
  }
};
