...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_booking_rejected', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_booking_rejected')->insert([
      'id' => 1,
      'logo' => '1739968217.jpg',
      'title' => 'Booking Rejected',
      'body' => 'We are regret to inform you that your booking has been rejected by [[handyman_name]] , placed on [[booking_date]].',
  ...
  {
    Schema::dropIfExists('email_provider_booking_rejected');
  }
};
