        ...
        <div class="relative w-full max-w-6xl p-6 mx-auto">
            ...
            <div class="flex w-full mx-auto md:space-x-6 mb-4">
                ...
                <div class="flex items-center w-full">
                    ...
                    {{-- <span id="line5" class="flex-grow block h-1 bg-gray-700 current-step"></span> --}}
                </div>
                        ...
                        <div class="grid items-center justify-between md:flex">
                            <div class="mt-[-1rem]">
                                <h2
                                    ...
                                    <b> Step 5 </b> : Installation Complete
                                </h2>
                        ...
                        <div class="container">
                            <div class="p-8 space-y-8 text-center">
                                ...
                                <div class="flex justify-center">
                                    <img src="./image/doneimage.png" alt="" srcset=""
                                        class="h-[7] w-[7rem]" />
                                </div>
                                ...
                                <div class="flex justify-center items-center w-full h-full mt-6">
                                    <a href="{{ url('/login') }}" class="next-btn">
                                        Continue to Admin
                                    </a>
                                </div>
                            </div>
