...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_booking_accepted', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_booking_accepted')->insert([
      'id' => 1,
      'logo' => '1740060500.jpg',
      'title' => 'Booking Accepted',
      'body' => 'Your Booking ID [[booking_id]] is accepted by [[provider_name]]. Thank you for choosing our service.',
  ...
  {
    Schema::dropIfExists('email_user_booking_accepted');
  }
};
