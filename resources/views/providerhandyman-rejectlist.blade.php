...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Handyman Rejected List<span
                        class="text-muted fw-normal ms-2">({{ $users->total() }})</span>
                </h5>
                <p class="text-muted">Handyman Payment / Handyman Rejected List</p>
            </div>
        </div>
    </div>
                                ...
                                @else
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('subbooking-view', $user->booking_id) }}" style="color: #246FC1;">
                                                    #{{ $user->booking_id ?? '' }}
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                @if ($user->payment_method === 'Cash')
                                                    <span class="badge bg-primary-subtle text-primary font-size-15">Cash</span>
