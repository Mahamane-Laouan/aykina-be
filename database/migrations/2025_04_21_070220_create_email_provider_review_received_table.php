...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_review_received', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_review_received')->insert([
      'id' => 1,
      'logo' => '1739969146.jpg',
      'title' => 'New Review Received',
      'body' => 'You have received a new review of booking [[booking_id]] for service [[service_name]] of [[rating]] star! Log in to your account to view more details and respond if needed.',
  ...
  {
    Schema::dropIfExists('email_provider_review_received');
  }
};
