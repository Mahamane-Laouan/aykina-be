        ...
        <div class="col-12 col-lg-4">
            <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
                <ul class="nav nav-align-left nav-pills flex-column">
                    ...
                    <li class="nav-item mb-1">
                        <a class="nav-link" href="{{ url('/cheque-payment') }}">
            ...
            <div class="tab-content p-0">
                ...
                <div class="tab-pane fade show active" id="store_details" role="tabpanel">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form id="addPayment" method="post" action="{{ route('flutterwave-payment-save') }}">
                                @csrf
                                <!-- Payment Flutterwave Key -->
                                <div class="row mb-3 g-3">
                                    <div class="col-12 col-md-12">
                                        <label class="form-label" for="publish_key">Payment Flutterwave Key<span
                                                style="color: red;"> *</span></label>
                                        <input type="text"
                                            value="{{ old('publish_key', optional($payments->firstWhere('payment_mode', 'flutterwave'))->publish_key) }}"
                                            placeholder="Enter Payment Flutterwave Key" name="publish_key"
                                            class="form-control @error('publish_key') is-invalid @enderror" />
                                        @error('publish_key')
                                    ...
                                    <!-- Flutterwave Secret -->
                                    <div class="col-12 col-md-12">
                                        <label class="form-label" for="secret_key">Flutterwave Secret<span
                                                style="color: red;">
                                                *</span></label>
                                        <input type="text"
                                            value="{{ old('secret_key', optional($payments->firstWhere('payment_mode', 'flutterwave'))->secret_key) }}"
                                            placeholder="Enter Flutterwave Secret" name="secret_key"
                                        ...
                                        <div class="w-25 d-flex justify-content-end">
                                            <label class="switch switch-primary switch-sm me-4 pe-2">
                                                <input type="checkbox" name="status" class="switch-input"
                                                    {{ optional($payments->firstWhere('payment_mode', 'flutterwave'))->status ? 'checked' : '' }}>
