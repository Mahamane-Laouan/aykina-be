...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_booking_hold', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_booking_hold')->insert([
      'id' => 1,
      'logo' => '1739885637.jpg',
      'title' => 'Booking Hold',
      'body' => 'Your booking is on hold by [[handyman_name]]. Thank you for choosing our service.',
  ...
  {
    Schema::dropIfExists('email_user_booking_hold');
  }
};
