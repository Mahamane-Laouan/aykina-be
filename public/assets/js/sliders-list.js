...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      columnDefs: [
        { visible: false, targets: [0] },
        {
          ...
          render: function (data, type, full, meta) {
            var $slider_name = full['slider_name'],
              $image = full['slider_image'];

            if ($image) {
              // For Avatar image
              var $output =
                '<img src="' + assetsPath + 'images/slider/' + $image + '" alt="Avatar" class="rounded-circle">';
            } else {
              // For Avatar badge
              ...
              var $state = states[stateNum],
                ...
                $initials = $slider_name.match(/\b\w/g) || [];
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $slider_description = full['slider_description'] || '';

            return '<span class="fw-medium">' + $slider_description + '</span>';
          }
        },
        {
          // Service
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if (status == '1') {
              return (
                ' <label class="switch switch-primary switch-sm me-4 pe-2"><input type="checkbox" id="active" name="status" class="switch-input" checked=""><span class="switch-toggle-slider"  onclick="ChangeSliderStatus(' +
                full.id +
                ',' +
                status +
              ...
              return (
                ' <label class="switch switch-primary switch-sm me-4 pe-2"><input id="inactive" type="checkbox" name="status" class="switch-input"><span class="switch-toggle-slider" onclick="ChangeSliderStatus(' +
                full.id +
                ',' +
                status +
                ')"><span class="switch-on"></span><span class="switch-off"></span></span></label>'
      ...
      buttons: [
        {
          text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Slider</span>',
