...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_booking_rejected', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_booking_rejected')->insert([
      'id' => 1,
      'logo' => '1739885707.jpg',
    ...
    {
        Schema::dropIfExists('email_user_booking_rejected');
    }
};
