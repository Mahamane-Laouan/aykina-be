...
@section('page-script')
    <script src="{{ asset('assets/js/banners-edit.js') }}"></script>
@endsection


@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Banners /</span><span> Edit Banners</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Edit Banners</h4>
                <p class="text-muted">Explore and edit banners</p>
            </div>
        </div>

        <form class="edit-banner pt-0" id="editBannerForm" method="post"
            action="{{ route('banners-update', ['id' => $banner->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- Banner Information -->
                            ...
                            <div class="row">
                                <div class="col-md-12" style="padding-bottom: 20px;">
                                    <label class="form-label" for="banners_name">Banner Name<span style="color: red;">
                                            *</span></label>
                                    <input type="text" id="banners_name" value="{{ $banner->banners_name }}"
                                ...
                                <div class="form-group" style="padding-bottom: 20px;">
                                    <label class="form-label" for="image">Banners<span
                                        ...
                                        <div class="existing-images-preview" style="display: flex; gap:0.5rem">
                                            @foreach ($existingImage as $image)
                                                <div class="existing-image"
                                                    ...
                                                    <img src="{{ asset('/assets/images/' . $image) }}" alt="Existing Image"
