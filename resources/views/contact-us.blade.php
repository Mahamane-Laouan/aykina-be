...
@section('body')
    ...
    @section('content')
        ...
        <div class="row align-items-center">
            <div class="col-md-3" style="padding-top: 18px;">
                <div class="mb-3">
                    <h5 class="card-title">Contact Us <span class="text-muted fw-normal ms-2"></span>
                    </h5>
                    <p class="text-muted">Pages / Contact Us</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12" style="padding-top: 25px;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('contactussave') }}" method="POST" id="contactusForm">
                            @csrf
    ...
    @section('scripts')
        ...
        <script>
            ...
            document.getElementById('contactusForm').onsubmit = function() {
