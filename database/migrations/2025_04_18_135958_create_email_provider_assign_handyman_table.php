...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_assign_handyman', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_assign_handyman')->insert([
      'id' => 1,
      'logo' => '1739968432.jpg',
      'title' => 'Order Cancelled',
      'body' => 'Booking ID [[booking_id]] has been Cancelled by [[user_name]].',
  ...
  {
    Schema::dropIfExists('email_provider_assign_handyman');
  }
};
