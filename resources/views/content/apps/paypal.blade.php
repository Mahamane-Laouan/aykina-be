                ...
                <div class="tab-pane fade show active" id="store_details" role="tabpanel">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title m-0">PayPal</h5>
                        </div>
                        <div class="card-body">
                            <form id="addPayment" method="post" action="{{ route('paypal-payment-save') }}">
                                @csrf
                                <!-- PayPal Client ID -->
                                <div class="row mb-3 g-3">
                                    <div class="col-12 col-md-12">
                                        <label class="form-label" for="publish_key">PayPal Client ID<span
                                                style="color: red;"> *</span></label>
                                        <input type="text"
                                            value="{{ old('publish_key', optional($payments->firstWhere('payment_mode', 'paypal'))->publish_key) }}"
                                            placeholder="Enter PayPal Client ID" name="publish_key"
                                    ...
                                    <!-- PayPal Secret -->
                                    <div class="col-12 col-md-12">
                                        <label class="form-label" for="secret_key">PayPal Secret<span style="color: red;">
                                                *</span></label>
                                        <input type="text"
                                            value="{{ old('secret_key', optional($payments->firstWhere('payment_mode', 'paypal'))->secret_key) }}"
                                            placeholder="Enter PayPal Secret" name="secret_key"
                                        ...
                                        <div class="w-25 d-flex justify-content-end">
                                            <label class="switch switch-primary switch-sm me-4 pe-2">
                                                <input type="checkbox" name="status" class="switch-input"
                                                    {{ optional($payments->firstWhere('payment_mode', 'paypal'))->status ? 'checked' : '' }}>
