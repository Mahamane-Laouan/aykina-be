...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_booking_cancelled', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_booking_cancelled')->insert([
      'id' => 1,
      'logo' => '1739371702.jpg',
      'title' => 'Booking Cancelled',
      'body' => 'Booking ID [[booking_id]] has been rejected by [[provider_name]]. Thank you for choosing our services, and we hope to assist you again in the future.',
    ...
    {
        Schema::dropIfExists('email_user_booking_cancelled');
    }
};
