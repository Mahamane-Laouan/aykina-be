...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_handyman_review_received', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_handyman_review_received')->insert([
      'id' => 1,
      'logo' => '1739971980.jpg',
      'title' => 'New Review Received',
      'body' => 'You have received a new review [[rating]] star for service [[service_name]] of booking ID [[booking_id]]! Log in to your account to view more details and respond if needed.',
  ...
  {
    Schema::dropIfExists('email_handyman_review_received');
  }
};
