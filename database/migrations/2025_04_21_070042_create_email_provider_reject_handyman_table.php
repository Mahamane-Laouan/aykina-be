...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_reject_handyman', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_reject_handyman')->insert([
      'id' => 1,
      'logo' => '1739968452.jpg',
      'title' => 'Reject Handyman',
      'body' => 'The [[handyman_name]] has rejected the [[booking_id]] of [[service_name]]. Please check your account for further details and next steps.',
    ...
    {
        Schema::dropIfExists('email_provider_reject_handyman');
    }
};
