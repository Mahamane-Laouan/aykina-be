...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_order_placed_service', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_order_placed_service')->insert([
      'id' => 1,
      'logo' => '1739360769.jpg',
      'title' => 'Your Booking Confirmation',
      'body' => "Hello {{username}}, We're excited to confirm your booking {{booking_id}}. Booking Details: Your Booking Status: {{booking_status}} Thank you for choosing us for your service needs. Best regards",
  ...
  {
    Schema::dropIfExists('email_user_order_placed_service');
  }
};
