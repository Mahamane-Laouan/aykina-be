...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_order_delivered', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_order_delivered')->insert([
      'id' => 1,
      'logo' => '1739968626.jpg',
      'title' => 'Order Delivered',
      'body' => 'We’re happy to inform you that your order of booking [[booking_id]] has been successfully delivered. Thank you for choosing us!',
  ...
  {
    Schema::dropIfExists('email_provider_order_delivered');
  }
};
