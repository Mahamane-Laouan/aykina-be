...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Handyman /</span><span> Edit Handyman</span>
    </h4>
    ...
    <div class="app-ecommerce">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">Edit Handyman</h4>
        ...
        <form class="edit-category pt-0" id="editCategoryForm" method="post"
            action="{{ route('handyman-update', ['id' => $user->id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-12 col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-tile mb-0">Handyman information</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row" style="padding-bottom: 8px;">
                                <div class="mb-3 col ecommerce-select2-dropdown" style="padding-top: 4px;">
                                    ...
                                    <select id="is_online" class="select2 form-select" name="is_online"
                                        ...
                                        <option value="1" {{ $user->is_online == '1' ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0" {{ $user->is_online == '0' ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                </div>
