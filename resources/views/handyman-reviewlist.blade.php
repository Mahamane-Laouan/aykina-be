...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                ...
                <p class="text-muted">Ratings / Handyman Ratings List</p>
            </div>
        </div>
    ...
    @if ($user->handyman)
        <div class="text-body d-flex align-items-center">
            <a href="{{ route('handyman-view', $user->handyman->id) }}" style="color: #246FC1;">
                                                ...
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item">
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                            ...
                                                            onclick="deleteHandymanReview({{ $user->id }})"><i
...
<script>
    ...
    function deleteHandymanReview(id) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.value) {
                $.ajax({
                    url: baseUrl + 'handymanreview-delete/' + id,
                    type: 'POST',
                    headers: {
    ...
    document.addEventListener('DOMContentLoaded', function() {
                ...
                if (searchInput) {
                    searchInput.addEventListener('keyup', function() {
                                ...
                                fetch(`{{ route('handyman-reviewlist') }}?search=${query}`, {
                                        headers: {
                                            ...
                                            if (data.records.length > 0) {
                                                data.records.forEach(record => {
                                                            const userProfile = record.handyman.profile_pic ?
                                                                `<img src="${record.handyman.profile_pic}" alt="User Image" class="avatar rounded-circle img-thumbnail me-2" style="min-width: 50px; height: 50px; object-fit: cover;">` :
                                                                `
                                    ...
                                    <td>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                                    class="px-2 text-danger"
                                                    onclick="deleteHandymanReview(${record.id})"><i
                                                    class="bx bx-trash-alt font-size-18"></i></a>
                                            </li>
                                        </ul>
                                    </td>
