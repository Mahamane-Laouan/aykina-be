...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_handyman_assign_fororder', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_handyman_assign_fororder')->insert([
      'id' => 1,
      'logo' => '1740060544.jpg',
      'title' => 'New Order Assign',
      'body' => 'You assigned a new service [[service_name]] of booking [[booking_id]]. Please ensure its completion promptly.',
  ...
  {
    Schema::dropIfExists('email_handyman_assign_fororder');
  }
};
