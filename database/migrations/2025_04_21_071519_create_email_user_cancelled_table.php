...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_cancelled', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_cancelled')->insert([
      'id' => 1,
      'logo' => '1740562022.png',
      'title' => 'User Cancelled By Provider',
      'body' => 'We’re excited to inform you that your account role has been successfully switched to a Vendor. You can now access vendor-specific features and manage your store listings.',
  ...
  {
    Schema::dropIfExists('email_user_cancelled');
  }
};
