...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_booking_accepted', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_booking_accepted')->insert([
      'id' => 1,
      'logo' => '1740060527.jpg',
      'title' => 'Handyman Booking Accepted',
      'body' => 'Your booking [[booking_id]] has been accepted by [[handyman_name]]. Thank you for choosing our service.',
  ...
  {
    Schema::dropIfExists('email_provider_booking_accepted');
  }
};
