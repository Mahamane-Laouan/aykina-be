...
@section('body')
    ...
    @endsection
    @section('content')
        {{-- Add Provider Headline --}}
        <div class="row align-items-center">
            <div class="col-9" style="padding-top: 18px;">
                <div class="mb-3">
                    <h5 class="card-title"> Add a new Provider <span class="text-muted fw-normal ms-2"></span>
                    </h5>
                    <p class="text-muted">Provider List / Add Provider</p>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Provider information</h4>
                    </div>
                    <div class="card-body">

                        <form action="{{ url('provider-save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" data-trigger id="is_blocked" name="is_blocked">
                                    ...
                                    <option value="1" {{ old('is_blocked', '1') == '1' ? 'selected' : '' }}>Active
                                    </option>
