...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_otp_verify', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_otp_verify')->insert([
      'id' => 1,
      'logo' => '1739965389.jpg',
      'title' => 'Otp Verification',
      'body' => 'Your verification code for email is',
    ...
    {
        Schema::dropIfExists('email_provider_otp_verify');
    }
};
