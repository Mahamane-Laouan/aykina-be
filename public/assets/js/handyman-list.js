...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="/handyman-edit/' +
              userId +
              '" class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></a>' +
              '<button class="btn btn-sm btn-icon delete-record" onclick="deleteHandyman(' +
              userId +
      ...
      buttons: [
        {
          text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Handyman</span>',
          className: 'add-new btn btn-primary',
          action: function (e, dt, node, config) {
            window.location.href = 'handyman-add';
          }
        }
      ],
      displayLength: 10,
