...
$email = ProviderEmailBookingRejected::first();
          ...
          ">
            ...
            ">
                    ...
                    <ul style="list-style-type: none; padding: 0">
                        ...
                        <li style="margin-bottom: 0.5rem">
                            <span style="font-weight: 600; color: #555555">Handyman Name: </span>
                            <span style="color: #555555"><?= htmlspecialchars($handyman_name) ?></span>
                        </li>
