...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Delivered Orders <span
                        class="text-muted fw-normal ms-2">({{ $records->total() }})</span>
                </h5>
                <p class="text-muted">Product Orders / Delivered Orders</p>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-success text-white font-size-14"
                                                    style="height: 30px; padding-top: 8px;">Delivered</span>
                                            </td>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('delivered-productbookinglist') }}?search=${query}`, {
                        headers: {
