    ...
    @section('content')
        ...
        <div class="row align-items-center">
            <div class="col-9" style="padding-top: 18px;">
                <div class="mb-3">
                    <h5 class="card-title"> Add a new Category <span class="text-muted fw-normal ms-2"></span>
                    </h5>
                    <p class="text-muted">Category List / Add Category</p>
                </div>
            </div>
                        ...
                        <form action="{{ url('category-save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="c_name" placeholder="Enter Category Name"
                                    name="c_name" value="{{ old('c_name') }}" aria-label="Plan Name">
