...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_product_delivered', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_product_delivered')->insert([
      'id' => 1,
      'logo' => '1735898866.png',
      'title' => 'Product Delivered',
      'body' => 'We’re happy to inform you that your product has been successfully delivered. Thank you for choosing us!',
  ...
  {
    Schema::dropIfExists('email_user_product_delivered');
  }
};
