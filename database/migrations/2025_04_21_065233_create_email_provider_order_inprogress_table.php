...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_order_inprogress', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_order_inprogress')->insert([
      'id' => 1,
      'logo' => '1739968612.jpg',
      'title' => 'Order In Progress',
      'body' => 'Order is in progress by [[handyman_name]] of booking [[booking_id]]. Thank you for choosing our service.',
  ...
  {
    Schema::dropIfExists('email_provider_order_inprogress');
  }
};
