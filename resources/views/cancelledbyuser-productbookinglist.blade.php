...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Cancelled By User Orders <span
                        class="text-muted fw-normal ms-2">({{ $records->total() }})</span>
                </h5>
                <p class="text-muted">Product Orders / Cancelled By User Orders</p>
            </div>
        </div>
        ...
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="input-group"
                ...
                <input type="text" id="searchSubCategoryInput" class="form-control"
                    placeholder="Search by user name or email" aria-label="Search" aria-describedby="search-icon"
                                   ...
                                   <td colspan="6" class="text-center">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <i class="bx bx-cart" style="font-size: 2.5rem; color: #fff;"></i>
                                            </div>
                                            <p
                                                style="margin-top: 0.6rem; font-size: 1.1rem; font-weight: 500; color: #444;">
                                                No Cancelled By User Orders Found</p>
                                        </div>
                                    </td>
                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-danger text-white font-size-14"
                                                    style="height: 30px; padding-top: 8px;">Cancelled By User</span>
                                            </td>
...
<script>
    ...
    function deleteProductBooking(id) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.value) {
                $.ajax({
                    url: baseUrl + 'productbooking-delete/' + id,
                    type: 'POST',
                    headers: {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('cancelledbyuser-productbookinglist') }}?search=${query}`, {
                        headers: {
