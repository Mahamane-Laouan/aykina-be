    ...
    @section('content')
        ...
        <div class="row align-items-center">
            <div class="col-md-3" style="padding-top: 18px;">
                <div class="mb-3">
                    <h5 class="card-title">Terms & Conditions <span class="text-muted fw-normal ms-2"></span>
                    </h5>
                    <p class="text-muted">Pages / Terms & Conditions</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12" style="padding-top: 25px;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('terms-conditionssave') }}" method="POST" id="termsConditionForm">
                            @csrf
                            <div id="snow-editor" style="height: 300px;">
                                {!! $term ? $term->text : '' !!}
                            </div>
                            <input type="hidden" name="text" id="text"
                                value="{{ old('text', $term ? $term->text : '') }}" />
