...
@section('content')
    <div class="row align-items-center">
        <div class="col-md-3" style="padding-top: 18px;">
            <div class="mb-3">
                <h5 class="card-title">Provider List<span class="text-muted fw-normal ms-2">({{ $users->total() }})</span>
                </h5>
                <p class="text-muted">Providers / Provider List</p>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center" style="padding-top: 15px;">
                    ...
                    <h2 class="card-title" style="margin-left: 25px;">Provider List</h2>

                    <a href="{{ route('provider-add') }}" class="btn btn-primary" style="margin-right: 25px;">Add
                        Provider</a>
                </div>
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch mb-3" dir="ltr"
                                                    ...
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        onchange="ChangeProviderListBlocked({{ $user->id }}, this.checked)"
                                            ...
                                            <td>
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a href="{{ route('provider-edit', $user->id) }}"
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top"
                                                            ...
                                                            onclick="deleteProvider({{ $user->id }})"><i
...
@section('scripts')
    ...
    <script>
        ...
        function ChangeProviderListBlocked(id, isChecked) {
            ...
            $.ajax({
                url: baseUrl + 'change-providerlistblocked/' + id,
                type: 'get',
                headers: {
...
<script>
    ...
    function deleteProvider(userId) {
        Swal.fire({
            title: 'Are you sure?',
            text: "You won't be able to revert provider!",
            icon: 'warning',
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Deleted!',
                            text: 'Service Provider deleted successfully.',
                            customClass: {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                fetch(`{{ route('providers-list') }}?search=${query}`, {
                        headers: {
    ...
    <td>
        <div class="form-check form-switch mb-3" dir="ltr" style="padding-top: 10px;">
            <input type="checkbox" class="form-check-input"
                ...
                onchange="ChangeProviderListBlocked(${record.id}, this.checked)" style="transform: scale(1.1);">
    ...
    ${record.profile_pic
        ...
        : `<img src="images/user/default_provider.jpg" class="avatar rounded-circle img-thumbnail me-2">`
                ...
                <small class="text-muted">${truncateText(record.email ?? '', 30)}</small>
                                    ...
                                    <td>${record.wallet_balance > 0 ? `${record.currency}${record.wallet_balance}` : `${record.currency}0`}</td>
                                    ...
                                    <td>
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item">
                                                <a href="${record.edit_url}" class="px-2 text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="bx bx-pencil font-size-18"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a class="px-2 text-danger" onclick="deleteProvider(${record.id})" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="bx bx-trash-alt font-size-18"></i></a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>`;
