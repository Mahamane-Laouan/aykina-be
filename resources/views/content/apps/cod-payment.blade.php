                ...
                <div class="tab-pane fade show active" id="store_details" role="tabpanel">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title m-0">Cash On Delivery (COD)</h5>
                        </div>
                        <div class="card-body">
                            <form id="addPayment" method="post" action="{{ route('cod-payment-save') }}">
                                @csrf
                                        ...
                                        <div class="w-25 d-flex justify-content-end">
                                            <label class="switch switch-primary switch-sm me-4 pe-2">
                                                <input type="checkbox" name="status" class="switch-input"
                                                    {{ optional($payments->firstWhere('payment_mode', 'cod'))->status ? 'checked' : '' }}>
