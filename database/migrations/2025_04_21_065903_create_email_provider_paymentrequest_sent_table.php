...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_provider_paymentrequest_sent', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_provider_paymentrequest_sent')->insert([
      'id' => 1,
      'logo' => '1739968972.jpg',
      'title' => 'Payment Request Sent',
      'body' => 'A payment request of amount [[currency]][[amount]] of booking [[booking_id]] has been submitted to admin. Please wait until the admin approves.',
  ...
  {
    Schema::dropIfExists('email_provider_paymentrequest_sent');
  }
};
