                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <img src="{{ asset('assets/images/Handyman_logo.png') }}" alt="Handyman"
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('auth-login') }}" method="post">
                            ...
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary d-grid w-100"
                                    style="background-color: #346FC1; color: white; border-color: #346FC1;">Sign in</button>
                            </div>
                        </form>
                        ...
                        <style>
                            ...
                            .btn-primary:hover {
                                background-color: #346FC1 !important;
                                border-color: #346FC1 !important;
                            }
                        ...
                        <div class="table-box">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>Email</td>
                                        <td id="email">primocys@gmail.com</td>
                                    </tr>
                                    <tr>
                                        <td>Password</td>
