...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      columnDefs: [
        { visible: false, targets: [0] },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var truncatedDesc =
              $service_description.length > maxDescLength
                ? $service_description.substring(0, maxDescLength) + '...'
                : $service_description;
            ...
            if ($image) {
              ...
              var $state = states[stateNum],
                ...
                $initials = $service_name.match(/\b\w/g) || [];
        ...
        },
        {
          ...
          render: function (data, type, full) {
            var provider_fullname = full['v_id'] || '';
        ...
        },
        {
          ...
          targets: 4,
          render: function (data, type, full, meta) {
            var $service_price = full['service_price'] || '';

            return '<span class="fw-medium"> $' + $service_price + '</span>';
          }
        },
        {
          // Status
          ...
          render: function (data, type, full, meta) {
            ...
            if (status == '1') {
              return (
                ' <label class="switch switch-primary switch-sm me-4 pe-2"><input type="checkbox" id="active" name="status" class="switch-input" checked=""><span class="switch-toggle-slider"  onclick="Changeproviderfeature(' +
                full.id +
                ',' +
                status +
              ...
              return (
                ' <label class="switch switch-primary switch-sm me-4 pe-2"><input id="inactive" type="checkbox" name="status" class="switch-input"><span class="switch-toggle-slider" onclick="Changeproviderfeature(' +
                full.id +
                ',' +
                status +
                ')"><span class="switch-on"></span><span class="switch-off"></span></span></label>'
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="/services-edit/' +
              userId +
              '" class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></a>' +
              '<button class="btn btn-sm btn-icon delete-record" onclick="deleteService(' +
              userId +
      ...
      buttons: [
        {
          text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Service</span>',
...
function Changeproviderfeature(id, status) {
  Swal.fire({
    title: 'Are you sure?',
