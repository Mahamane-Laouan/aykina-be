...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('email_user_product_in_progress', function (Blueprint $table) {
      $table->id();
    ...
    DB::table('email_user_product_in_progress')->insert([
      'id' => 1,
      'logo' => '1735896770.png',
      'title' => 'Product In Progress',
      'body' => 'We are pleased to inform you that your Product Order ID [[booking_id]] is In Progress. Our team is working diligently to ensure everything meets your expectations.',
    ...
    {
        Schema::dropIfExists('email_user_product_in_progress');
    }
};
