...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      columns: [{ data: 'id' }, { data: 'banners_name' }, { data: 'image' }, { data: 'action' }],
      columnDefs: [
        { visible: false, targets: [0] },
        {
          ...
          render: function (data, type, full, meta) {
            var $banners_name = full['banners_name'];
            var $output;

            {
              ...
              var $state = states[stateNum],
                $banners_name = full['banners_name'],
                $initials = $banners_name.match(/\b\w/g) || [];
          ...
          render: function (data, type, full, meta) {
            ...
            if ($image) {
              ...
              return (
                ...
                'images/' +
                $image +
                '" alt="Category Image" class="img-thumbnail" style="height: 66px; width: 20%;">'
              );
            } else {
              // You can display a placeholder image or an alternative content
              return 'No Image';
            }
          }
        },

        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<button class="btn btn-sm btn-icon delete-record" onclick="deleteBanner(' +
              userId +
