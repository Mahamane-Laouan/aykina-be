...
@section('body')
    ...
    @endsection
    @section('content')
        {{-- Edit Coupon Headline --}}
        <div class="row align-items-center">
            <div class="col-9" style="padding-top: 18px;">
                <div class="mb-3">
                    <h5 class="card-title">Edit Coupon <span class="text-muted fw-normal ms-2"></span>
                    </h5>
                    <p class="text-muted">Coupon List / Edit Coupon</p>
                </div>
            </div>

            <div class="col-3 text-end">
                <a href="/coupon-list" class="btn btn-secondary">Back</a>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('coupon-update', ['id' => $user->id]) }}" method="POST"
                            ...
                            <div class="row mb-3" style="row-gap: 1rem;">
                                ...
                                <div class="col-md-12 d-flex" style="flex-direction: column;">
                                    ...
                                    <span id="status_error" class="error text-danger">
                                        {{ $errors->first('status') }}
                                    </span>
                                </div>
                            </div>
